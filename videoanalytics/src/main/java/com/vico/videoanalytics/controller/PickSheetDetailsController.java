...
public class PickSheetDetailsController {
    ...
    @GetMapping("/pickSheetDetailsByPickSheet/{pickSheet}")
    public List<PickSheetDetails> getPickSheetDetailsByPickSheet(@PathVariable(value = "pickSheet") PickSheet pickSheet) {
